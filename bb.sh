...
# BEGINN
# These lines between "beginn" and "end" were written by me
# 1. Install discount (or other markdown processor)
# 2. add export EDITOR=[editor name] in .bashrc
# 3. edit global variables after global_variables() { 
# 4. change css 
# END
